...
export class SkillGroupMapper {
  ...
  static fromSkillGroupDto(dto: SkillGroupDto, iconsService: IconsService): SkillGroup {
  ...
  static fromSkillGroupDtos(dtos: SkillGroupDto[], iconsService: IconsService): SkillGroup[] {
    return dtos.map(dto => SkillGroupMapper.fromSkillGroupDto(dto, iconsService));
  }
}
