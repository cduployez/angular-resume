...
export class ExperienceFactory {
  static getAll(): ExperienceItem[] {
    return [
      new ExperienceItem(
        CvDate.monthRange(DateUtils.fromDate(1, 10, 2022), /* Current */ null),
        "Worldline",
        JobTypeEnum.CDI,
        "Projet Ecobonus",
        [
        ...
        [
          ...
          new SkillBadge(
            "Openshift",
            SkillEnumUtils.openshiftKeyword,
            SkillEnumUtils.openshiftChildrenKeywords
          ),
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 7, 2021),
          DateUtils.fromDate(30, 9, 2022)
        ),
        "Worldline",
        JobTypeEnum.CDI,
        "Projet Maela",
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 1, 2021),
          DateUtils.fromDate(30, 6, 2021)
        ),
        "Worldline",
        JobTypeEnum.CDI,
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 1, 2018),
          DateUtils.fromDate(31, 12, 2020)
        ),
        "Worldline",
        JobTypeEnum.CDI,
        "Projet SI-VIC",
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 9, 2017),
          DateUtils.fromDate(31, 12, 2017)
        ),
        "Worldline",
        JobTypeEnum.CDI,
        "Projet Télépaiement",
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 9, 2016),
          DateUtils.fromDate(31, 8, 2017)
        ),
        "Worldline",
      ...
      new ExperienceItem(
        CvDate.monthRange(
          DateUtils.fromDate(1, 5, 2016),
          DateUtils.fromDate(31, 7, 2016)
        ),
