...
export class SkillEnumUtils {
  ...
  static readonly springChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.javaKeyword;

  static readonly keycloakKeyword: SkillEnum[] = [SkillEnum.KEYCLOAK];

  static readonly javaEeKeyword: SkillEnum[] = [SkillEnum.JAVA_EE];

  static readonly javaEeChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.javaKeyword;

  static readonly pythonKeyword: SkillEnum[] = [SkillEnum.PYTHON];

  static readonly openCvChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.pythonKeyword;

  static readonly androidChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.javaKeyword;

  static readonly xamarinChildrenKeywords: SkillEnum[] = [
    SkillEnum.C_SHARP,
    SkillEnum.ANDROID,
  ];
  ...
  static readonly netChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.cSharpKeyword;

  static readonly mvcNetChildrenKeywords: SkillEnum[] = [
    SkillEnum.C_SHARP,
    SkillEnum.HTML,
  ];
  ...
  static readonly angularChildrenKeywords: SkillEnum[] = [
    SkillEnum.TYPESCRIPT,
    SkillEnum.CSS,
    SkillEnum.HTML,
  ];

  static readonly webKeywords: SkillEnum[] = [
    SkillEnum.HTML,
    SkillEnum.CSS,
    SkillEnum.JAVASCRIPT,
  ];

  static readonly apacheTapestryKeyword: SkillEnum[] = [
    SkillEnum.APACHE_TAPESTRY,
  ];

  static readonly apacheTapestryChildrenKeywords: SkillEnum[] = [
    SkillEnum.HTML,
    SkillEnum.CSS,
    SkillEnum.JAVA,
  ];
  ...
  static readonly kubernetesChildrenKeywords: SkillEnum[] =
    SkillEnumUtils.dockerKeyword;

  static readonly azureKeyword: SkillEnum[] = [SkillEnum.AZURE];

  static readonly azureChildrenKeywords: SkillEnum[] = [
    SkillEnum.DOCKER,
  ...
  static readonly openshiftChildrenKeywords: SkillEnum[] = [
    SkillEnum.DOCKER,
    SkillEnum.KUBERNETES,
  ];
}
